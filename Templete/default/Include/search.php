        ...
        <!--mid left-->
         ...
         <!--mid right-->
            <div class="sc_mid_c_right">
                <div class="sc_mid_tits" id="botalink"><a href="<?php echo $web_url; ?>"><?php echo $tag_home; ?></a> > <?php echo $search;?></div>
                <div class="cb"></div>
                <div class="sc_mid_c_right_c"><?php echo searchprolist($Language,$tag_inquiry,$web_url,$search,$webplist)?></div>
