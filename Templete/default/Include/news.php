...
<title><?php if($ID==""){echo $tag_newkey;}else{ echo pnlmcc($Language,$ID,"category_key");}?></title>
<meta content="<?php if($ID==""){echo $tag_newkey;}else{ echo pnlmcc($Language,$ID,"category_key");}?>" name="keywords">
<meta content="<?php if($ID==""){echo $tag_newdes;}else{ echo pnlmcc($Language,$ID,"category_des");}?>" name="description">
        ...
        <!--mid left-->
         ...
         <!--mid right-->
            <div class="sc_mid_c_right">
                <div class="sc_mid_tits"><a href="<?php echo $web_url; ?>"><?php echo $tag_home; ?></a> > <?php if ($ID==""){echo $tag_news;}else{ echo nlmcc($Language,$ID);}	?></div>
                <div class="cb"></div>
                <div class="sc_mid_c_right_c"><?php echo  newslist($Language,$web_url,$ID,$tag_news,$webnlist)?></div>
